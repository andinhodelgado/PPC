...
//    public static String url = "https://www.usinasantafe.com.br/ppcprod/" + versao + "/view/";
	...
	public static String localPSTVariavel = "br.com.usinasantafe.ppc.model.bean.variaveis.";
	public static String localPSTEstatica = "br.com.usinasantafe.ppc.model.bean.estaticas.";
	public static String localUrl = "br.com.usinasantafe.ppc.util.conWEB.UrlsConexaoHttp";
